// =============================================================== //
// ================= YouTube Embedded Player Service ============= //
// =============================================================== //
...
angular.module('youtube-embed', ['ng'])
     ...
     * youtubeEmbedUtils
     *
     * Perform common General Purpose YouTube functions. A set of util functions.
     */
    ...
    .service ('youtubeEmbedUtils', ['$window', '$rootScope', function ($window, $rootScope) {
         ...
         * contains()
         *
         * Returns the truth value of the first string containing the second string
         * 
         * @param String - str
         * @param String - substr
         * @return Boolean
...
// ================================================================= //
// ================= YouTube Embedded Player Directive ============= //
// ================================================================= //
